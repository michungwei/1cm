		...
		<div id="content">
			...
			<div class="article">
			  ...
			  <div class="share">
				...
				<div class="sweb">
				  <ul>
					<li>
					  <a href="#"><span class="ic fb"></span>facebook</a>
					</li>
					<li>
					  <a href="#"><span class="ic instagram"></span>instagram</a>
					</li>
					<li>
					  <a href="#"><span class="ic lineicon"></span>line</a>
					</li>
					<!--<li>
		  ...
		  <div id="rightbar">
			...
			<div class="graybox">
				...
				<div class="addlike">
					<div class="ic fblike"><a href="https://www.facebook.com/pages/1cm/761735067202346">fblike</a></div>
					<p><span class="ic heart"></span><?php echo floor(get_facebook_likes('https://www.facebook.com/1cmLife') / 1000).'K'; ?></p>
				</div>
			</div>
			<!--ad-->
			<div class="ad">
