			...
			<div class="article">
			  ...
			  <div class="mobile_webicon">
				<ul>
				  ...
				  <li>
					<a href="#"><span class="mic mfblike"></span><?php echo floor(get_facebook_likes('<?php echo $web_fb_url;?>') / 1000).'K'; ?></a>
				  </li>
				  <li>
					<a href="#"><span class="mic mfbshare"></span><?php echo floor(get_facebook_likes('<?php echo $web_fb_url;?>') / 1000).'K'; ?></a>
				  </li>
				</ul>
			  </div>
			  <div class="n_time">
				...
				<div class="sweb">
				  <ul>
                   ...
                   config='height=小視窗高度,width=小視窗寬度')"><span class="ic fb"></span>facebook</a>
					...
					<li>
					  <a href="<?php echo $web_fb_url;?>"><span class="ic instagram"></span>instagram</a>
					</li>
					<li>
