...
$sql = "SELECT * 
	    ...
	    WHERE n.news_id<$startId AND n.newsType_id=nt.newsType_id AND a.admin_id=n.news_aut_id AND n.$news_upday<=NOW() AND n.$isshow_news = 1 $sql_str
		...
		<section id="content">
			...
			<div id="content_" class="content_section">
				...
				<div class="like_section hidden-mobile">
					...
					echo '<p style="margin-top: 0px;"><img src="images/like_block_titleChoice.png" alt=""></p>';
					}
					?>
                    <?php
					$i=1;
				...
				<div class="like_section visible-mobile">
					<?php
					if($rows_likenews!=false){
					echo '<p><img src="images/like_block_titleChoice.png" alt=""></p>';
					}
					?>
                    <?php
					$i=1;
