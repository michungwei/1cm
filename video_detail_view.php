...
$sql = "SELECT * 
		...
		WHERE n.newsType_id=nt.newsType_id AND a.admin_id=n.news_aut_id AND n.news_id='$nid' AND n.$news_upday<=NOW()";
...
<head>
    ...
    <script>
		function share2FB(){
		 	window.open("http://www.facebook.com/sharer/sharer.php?u=<?php echo $web_url."viedo_detail.php?nid=".$nid; ?>",'','width=653,height=369');
		}
	</script>
		...
		$(function(){
				$('.infinite_container').infinitescroll({
					...
					path: function(index) {
						...
						return "video_detail.php?nid=<?php echo $nid; ?>&page=" + index;
					},
	...
	<script>(function(d, s, id) {
	  ...
	  fjs.parentNode.insertBefore(js, fjs);
		...
		<div id="content">
		  ...
		  <div class="left_content">
			...
			<div class="article">
			  ...
			  <div class="mobile_webicon">
				<ul>
				  ...
				  <li>
					<a href="#"><span class="mic mfblike"></span><?php echo floor(get_facebook_likes('https://www.facebook.com/1cmLife') / 1000).'K'; ?></a>
				  </li>
				  <li>
					<a href="#"><span class="mic mfbshare"></span><?php echo floor(get_facebook_likes('https://www.facebook.com/1cmLife') / 1000).'K'; ?></a>
				  </li>
				</ul>
			  </div>
			  <div class="n_time">
				<span class="ic day"></span><span class="mic mday hidden-tablet"></span>
				<?php 
					echo "20";
			...
			<div class="artical02">
			  ...
			  <ul class="artad">
				<li>
				  <a href="https://www.facebook.com/1cmLife">
			  ...
			  <ul>
				...
				?>
					<li>
					  <a href="viedo_detail.php?nid=<?php echo $row_prenews["news_id"];?>">
						<div class="sarticle">
				...
				?>
					<li>
					  <a href="viedo_detail.php?nid=<?php echo $row_nextnews["news_id"];?>">
						<div class="sarticle">
			...
			<div class="mobile_may">
			  ...
			  <div class="may_news">
				<div class="may_pic">
				  <a href="viedo_detail.php?nid=<?php echo $row_likenews["news_id"];?>">
			  ...
			  <div class="twobox">
				<?php
				  ...
				  foreach($rows_news as $row_news){
					...
					{
				?>
					<div class="box220 <?php if($i == 0) echo 'mright';?>">
					  <!--newbox-->
					  <div class="newbox">
						<div class="n_pic">
						  <a href="viedo_detail.php?nid=<?php echo $row_news["news_id"];?>">
		...
		<div id="content">
		  ...
		  <div class="clear_both"></div>
		  <div id="page-nav">
			<a href="video_detail.php?nid=<?php echo $nid; ?>&page=1"></a>
		  </div>
		</div>
	</div>	
<!-- lazyload -->
