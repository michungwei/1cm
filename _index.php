		...
		$(function(){
				$('.left_content').infinitescroll({
					...
					path: function(index) {
						...
						return "<?php echo $href; ?>index.php?page=" + index;
					},
...
<body>
	...
	<!-----左邊內容區 left_content----->
		...
		<?php
			...
			?>
				<?php		
					if($i % 4 == 0 && strcasecmp($row_newt["newsType_Ename"],"VIDEO"))
					{
				?>
						<!--ad-->
								...
								<div class="newbox">
									<div class="n_pic">
										<a href="<?php echo $href; ?>news_detail.php?nid=<?php echo $row_news["news_id"];?>">
											<img src="<?php echo $web_path_news,"m",$row_news["news_banner"];?>" width="450" height="250">
										</a>
									</div>
									<div class="n_data">
										<ul>
											<li class="n_title01"><a href="<?php echo $href; ?>news_detail.php?nid=<?php echo $row_news["news_id"];?>"><?php echo $row_news["news_title"];?></a></li>			
				...
				?>
			<?php		
					if($i % 4 == 1 && strcasecmp($row_newt["newsType_Ename"],"VIDEO"))
					{
			?>
						<!--ad-->
						<div class="ad728 ad"><?php if(isset($adv["11"])){echo $adv["11"];}?></div>
			...
			?>			
				...
				<?php		
					if($i % 4 == 2 && strcasecmp($row_newt["newsType_Ename"],"VIDEO"))
					{
				?>
						<!--ad-->
						<div class="ad728 ad"><?php if(isset($adv["11"])){echo $adv["11"];}?></div>
				...
				?>			
					...
					?>			
								...
								<div class="vbox <?php if($j % 2 == 0) echo 'mr';?>">
									<a href="<?php echo $href; ?>video_detail.php?nid=<?php echo $row_news["news_id"];?>">
										<div class="vdata">
											<ul>
											  <li class="vtitle"><?php echo tc_left(strip_tags($row_news["news_title"]),30)?></li>
										...
										<div class="vpic"><img src="<?php echo $web_path_news,"s",$row_news["news_banner"];?>" width="360" height="200"></div>
									</a>
								</div>
							<?php
							}
