...
shuffle($rows_rnews);
$rows_rnews = array_slice($rows_rnews, 0, 8);
...
shuffle($rows_likenews);
$rows_likenews = array_slice($rows_likenews, 0, 8);
...
<meta name="copyright" content="<?php echo $copyright; ?>" />
	...
	<link rel="stylesheet" href="css/style.css?ver=150414">
	...
	<script>
		$(function(){
			...
			$('#page-nav').click(function() {
				...
				$('#content_').infinitescroll('retrieve');
				return false;
			});
				...
				<div class="content_sectionL content_sectionL_in" id="content_sectionL">
					...
					<div class="content_block news_detail_block">
						...
						<div class="description">
							...
							$row_news["news_content"] = str_replace('src="http://onecentimetre.com/', 'src="', $row_news["news_content"]);
